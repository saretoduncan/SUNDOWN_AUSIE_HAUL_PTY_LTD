              ...
              <section className="grid gap-4 md:gap-y-4 ">
                ...
                <div className="grid ">
                  ...
                  <FaqsCardComponents
                    ...
                    answer="Sundown Aussie Haul specializes in long haulage, short haulage, and iron ore haulage. We also provide blue rock haulage services across Western Australia. Our team is dedicated to ensuring safe and efficient transport for all your needs."
                  />
                </div>
                <hr className="border-orange-500" />
                <div className="grid ">
                ...
                <div className="grid ">
                  <FaqsCardComponents
                    ...
                    answer="Yes, all our haulage services are fully insured. We prioritize the safety and security of your cargo. Rest assured, your materials are in good hands with Sundown Aussie Haul."
                  />
                </div>{" "}
                <hr className="border-orange-500" />
                <div className="grid ">
