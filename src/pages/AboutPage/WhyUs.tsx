              ...
              <section>
                ...
                <div>
                  <p>
                    ...
                    , our mission is to provide reliable, efficient, and safe
                    freight transportation solutions across Australia. We are
                    committed to delivering exceptional service, fostering
                    long-term partnerships with our clients, and ensuring the
                    highest standards of professionalism and sustainability in
                    every haul.
                  </p>
                </div>
              </section>
              <section>
                ...
                <div>
                  <p>
                    ...
                    company, recognized for innovation, operational excellence,
                    and environmental responsibility. We aim to drive progress
                    in the logistics industry while supporting the growth of
                    Australian businesses and connecting communities through
          ...
          <div className="">
            <section>
              <div className="flex space-x-2 md:w-1/4"> 
                <h5 className="text-orange-500 font-bold text-xl capitalize ">Our core values</h5>{" "}
                <hr className="flex-grow border-orange-500 self-center" />
              </div>
            </section>
            <section>
